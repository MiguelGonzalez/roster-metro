package rostermetroswing.models;
...
/**
 * Modelo de la tabla que representa la información de una ruta (paradas y
 * líneas por la que pasa).
 *
...
public class TablaRutaModel extends AbstractTableModel {
    ...
    public int getRowCount() {
        return ruta == null ? 1 : ruta.getListadoParadas().size();
    }
